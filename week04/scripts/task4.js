...
info.favoriteFoods.forEach((food) => {
    let favFoodElement = document.createElement('li');
    favFoodElement.textContent = food;
    document.querySelector('#favorite-foods').appendChild(favFoodElement);
});
